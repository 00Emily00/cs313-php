...
$stmt = $db->prepare("SELECT q.questions FROM questions q INNER JOIN questionanswer qa ON q.questionid = qa.qid");
...
$stmt = $db->prepare("SELECT a.answers FROM answers a INNER JOIN questionanswer qa ON a.answerid = qa.aid WHERE aid='qid'");
$stmt->execute();
