...
$stmt = $db->prepare("SELECT * FROM questions q INNER JOIN questionanswer qa ON q.questionid = qa.qid WHERE qid=1");
...
$stmt = $db->prepare("SELECT * FROM answers a INNER JOIN questionanswer qa ON a.answerid = qa.aid WHERE aid=1");
$stmt->execute();
